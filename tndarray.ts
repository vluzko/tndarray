...
class tndarray {
   ...
   * @private
   */
  private _index_iterator(): Iterable<any> {
    let iter = {};
  ...
  //  */
  //  */
  // static add(value1: number | tndarray, value2: number | tndarray): number | tndarray {
  //   if (value1 instanceof tndarray) {
  //     if (value2 instanceof tndarray) {
  //
