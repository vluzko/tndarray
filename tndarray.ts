...
class tndarray {
   ...
   * @private
   */
  private static _binary_broadcast(a: Broadcastable, b: Broadcastable, f: (a: number, b: number) => number, dtype?: string): Broadcastable {
   ...
   */
  static mult(a: Broadcastable, b: Broadcastable): Broadcastable {
     return tndarray._binary_broadcast(a, b, (x, y) => x * y);
  }
   ...
   */
  static div(a: Broadcastable, b: Broadcastable): Broadcastable {
